...
print('1 Binary halfs a orederd list and the list has to be orderd liner checks it one by one')
...
print('It would take 5 steps to get to 98')
...
print('it would take binary 3 steps')

# 4. In your own words describe what an algorithm is. 
# Please write your response using complete sentences.
print('A algorithm is code that is used to preform a task')
...
# Please write your response using complete sentences.
print(" they used binary search how you may ask well they know the floor and the room so they don't have to move that much ")
...
# Please write your response using complete sentences.
print(" I would binary as I know were I left the phone ")
...
class game:
   def __init__(self,fanspeed,consoleControlls, display, download)
    self.fanspeed=fanspeed
    self.consoleControlls=consoleControlls
    self.download=download
    self.display=display
    self.tempulter=tempulter
